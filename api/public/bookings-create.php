...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    // Завантажуємо потрібні дані для листа
    $serviceName = 'Послуга';
    ...
    // Додаємо опції до назви послуги
    ...
    // URL керування бронюванням (зробимо завтра)
    ...
    $clientSubject = renderEmailTemplate($clientSubject, [
        'code' => $code,
        'name' => $name,
    ]);
    ...
    $clientResult = sendEmail($email, $name, $clientSubject, $clientBody);
    ...
    if (!empty($adminEmail)) {
        ...
        $adminResult = sendEmail($adminEmail, 'Адмін', $adminSubject, $adminBody);
    }
